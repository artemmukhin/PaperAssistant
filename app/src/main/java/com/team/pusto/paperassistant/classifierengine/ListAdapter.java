...
public class ListAdapter extends BaseAdapter {
    ...
    public ListAdapter(Context context, ArrayList<File> items) {
    ...
    public View getView(int arg0, View convertView, ViewGroup arg2) {
        ...
        String resId =  items.get(arg0).getAbsolutePath(); /*context.getResources().getIdentifier(items.get(arg0),
    ...
    public void loadBitmap(String resId, ImageView imageView) {
        if (cancelPotentialWork(resId, imageView)) {
            ...
            imageView.setBackgroundResource(R.drawable.not32);
            task.execute(resId);
        }
    }
    ...
    class BitmapWorkerTask extends AsyncTask<String, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(String... params) {
            data = params[0];
            final Bitmap bitmap = MainActivity.decodeSampledBitmapFromFile(data, 100, 100);
